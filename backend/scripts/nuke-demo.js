...
const directTables = [
  'transactions', 'categories', 'accounts', 'budgets', 'budgets_zero_based',
  'savings_goals', 'retirement_goals', 'emergency_fund_config', 'loans',
  'bills', 'housings', 'tags', 'category_mappings', 'recurring_transactions',
  'receipts', 'portfolio_holdings',
]
