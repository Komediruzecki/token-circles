...
- [x] **Savings rate goal** — Set a target savings rate % and track progress monthly
...
- [x] **Loan amortization table** — Detailed month-by-month breakdown with export option
