...
- **Badges.** Tracking your money now earns badges: a month tracked, a quarter, a year, saving streaks, budgets held, and more. Thirty-four in four bands, from your first entry to a twenty-year ladder, with a badge for coming back after a break, for a month where everything is named and every budget held, for a year entirely in the black, and for paying off a loan. Per profile, worked out on your device, never taken away, and each one shareable as a card. Your history counts from day one.
