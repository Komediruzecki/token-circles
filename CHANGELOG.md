...
- **Badges.** Tracking your money now earns badges: a month tracked, a quarter, a year, saving streaks, budgets held, and more. Twenty-four in four bands, up to a twenty-year ladder and a badge for twenty thousand entries, per profile, worked out on your device, never taken away, and each one shareable as a card. Your history counts from day one.
