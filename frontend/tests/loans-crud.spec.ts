...
test.describe('Loans CRUD Operations', () => {
  ...
  test('should have summary cards', async ({ page }) => {
    ...
    await expect(page.locator('.loans-summary .summary-card:has-text("Total Borrowed")')).toBeVisible();
    await expect(page.locator('.loans-summary .summary-card:has-text("Remaining Balance")')).toBeVisible();
    await expect(page.locator('.loans-summary .summary-card:has-text("Active Loans")')).toBeVisible();
  ...
  test('should display total borrowed amount', async ({ page }) => {
    ...
    const totalBorrowed = page.locator('.loans-summary .summary-card:has-text("Total Borrowed") .summary-value');
  ...
  test('should display remaining balance', async ({ page }) => {
    ...
    const remainingBalance = page.locator('.loans-summary .summary-card:has-text("Remaining Balance") .summary-value');
  ...
  test('should display active loans count', async ({ page }) => {
    ...
    const activeLoans = page.locator('.loans-summary .summary-card:has-text("Active Loans") .summary-value');
  ...
  test('should have calculator for monthly payment', async ({ page }) => {
    ...
    const hasDetails = await page.locator('.loan-details').isVisible({ timeout: 2000 }).catch(() => false);
  ...
  test('should calculate remaining balance correctly', async ({ page }) => {
    ...
    const hasProgress = await page.locator('.loan-progress').isVisible({ timeout: 2000 }).catch(() => false);
