define(['exports'], function (t) {
  ...
  function x(t) {
    return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
      ? (
        ...
        ? function (...e) {
            return (t.apply(E(this), e), I(R.get(this)))
          }
        : function (...e) {
            return I(t.apply(E(this), e))
          }
      : function (e, ...s) {
  ...
  class j {
    ...
    async expireEntries() {
      ...
      const t = this.D ? Date.now() - 1e3 * this.D : 0,
        e = await this.L.expireEntries(t, this.q),
    ...
    async updateTimestamp(t) {
      await this.L.setTimestamp(t, Date.now())
    }
    async isURLExpired(t) {
      if (this.D) {
        const e = await this.L.getTimestamp(t),
    ...
    async delete() {
      ;((this.v = !1), await this.L.expireEntries(1 / 0))
    }
  }
  function P(t, e) {
    const s = new URL(t)
  ...
  class K {
    ...
    async fetch(t) {
      ...
      try {
        let t
        t = await fetch(n, 'navigate' === n.mode ? void 0 : this.I.fetchOptions)
    ...
    async cacheMatch(t) {
      const e = S(t)
      let s
      const { cacheName: n, matchOptions: i } = this.I,
    ...
    async cachePut(t, e) {
      ...
      var a
      const o = await this.k(e)
      if (!o) return !1
      const { cacheName: c, matchOptions: h } = this.I,
    ...
    async getCacheKey(t, e) {
      ...
      if (!this._[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = S(await t({ mode: e, request: n, event: this.event, params: this.params }))
        this._[s] = n
      }
      return this._[s]
    }
    hasCallback(t) {
      for (const e of this.I.plugins) if (t in e) return !0
      return !1
    }
  ...
  class A {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new K(this, { event: e, request: s, params: n }),
        r = this.M(i, s, e)
      return [r, this.T(r, i, s, e)]
    }
    async M(t, e, n) {
      let i
  ...
  class G {
    constructor({ precacheController: t }) {
      ;((this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s = (null == e ? void 0 : e.cacheKey) || this.P.getCacheKeyForURL(t.url)
  ...
  ;((z.defaultPrecacheCacheabilityPlugin = {
    ...
    (z.copyRedirectedCacheableResponsesPlugin = {
      cacheWillUpdate: async ({ response: t }) => (t.redirected ? await Q(t) : t),
    }))
  class X {
  ...
  ;((t.CacheFirst = class extends A {
    ...
    (t.ExpirationPlugin = class {
      ...
      J(t) {
        ...
        let e = this.Y.get(t)
        return (e || ((e = new j(t, this.X)), this.Y.set(t, e)), e)
      }
      V(t) {
        if (!this.D) return !0
        const e = this.Z(t)
    ...
    (t.createHandlerBoundToURL = function (t) {
      return Y().createHandlerBoundToURL(t)
    }),
...
//# sourceMappingURL=workbox-cc85cf5a.js.map
