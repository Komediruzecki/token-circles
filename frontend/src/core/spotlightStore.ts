...
export const SPOTLIGHT_STEPS: SpotlightStep[] = [
  ...
  },
  {
    ...
    description: 'See your income, expenses, and net balance at a glance. Use the period pills and month/year controls to switch timeframes.',
    placement: 'bottom',
    section: 'dashboard',
  ...
  },
  {
    ...
    description: 'Net worth, income, expenses, and month-over-month deltas. Each card shows your current financial snapshot.',
    placement: 'bottom',
    section: 'dashboard',
    requiredPage: 'dashboard',
  },
