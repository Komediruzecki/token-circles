 ...
 *
 * Accepts plain decimals, US/EU grouped values, grouped spaces, signs, and
 * accounting negatives. A single separator followed by exactly three digits
 * with a one-to-three digit prefix is rejected as ambiguous (`1,234`).
 */
