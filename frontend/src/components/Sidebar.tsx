...
export default function Sidebar() {
  ...
  const closeOnOutsideClick = (e: MouseEvent) => {
    ...
    const dropdown = (e.currentTarget as HTMLElement).querySelector(
  ...
  return (
    <>
      ...
      <div
        ...
        classList={{ [styles.mobileOverlayVisible]: isMobileOpen() }}
      />

      {/* Sidebar */}
      <nav class={styles.sidebar} data-component="sidebar">
        <div class={styles.sidebarHeader}>
          <button class={styles.hamburgerBtn} data-action="toggleSidebar" aria-label="Toggle menu">
        ...
        <div class={styles.profileSelector}>
          <div class={styles.profileDropdown}>
            ...
            >
              <span class={styles.profileName} id="profile-btn-name">
                Loading...
              </span>
              <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div style="padding: 0 16px; margin-bottom: 12px">
          <div id="login-section">
            <button
              class={`${styles.btn} ${styles.btnSecondary} ${styles.btnSm}`}
              style="width: 100%"
            ...
            {(item) => (
              ...
              >
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                  ...
                  {item.icon === 'goals' && <path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />}
                  {item.icon === 'bills' && (
