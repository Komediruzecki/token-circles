...
const iconPatterns: [RegExp, IconDef][] = [
  ...
  [/entertain|fun|game|movie|cinema|theatre|theater|concert|music|stream|netflix|spotify|hulu|disney|hbo/i, { path: 'entertainment' }],
  [/shop|retail|cloth|apparel|mall|amazon|walmart|target|costco/i, { path: 'shop' }],
  [/health|medical|doctor|dentist|pharma|hospital|clinic|therapy|vet|vision|eye|glasses/i, { path: 'health' }],
  [/edu|school|college|university|tuition|book|course|class|learn|study|student/i, { path: 'book' }],
