  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path
        ...
        fill="currentColor"
      />
      <path d="M3 19.5c0 .5.5.5 1 .5 1 0 2.5-1 4-1 1.5 0 3 .5 5 .5s3.5-.5 5-.5 3 1 4 1c.5 0 1 0 1-.5-.5-1-1.5-2-3-2-1.5 0-3 .5-5 .5s-3.5-.5-5-.5-3 .5-5 .5c-1 0-2-.5-2-1.5 0-1 1-1.5 2-1.5v-1c-2 0-3.5 1-3.5 2.5z" fill="currentColor" />
    </svg>
  )
}
...
export function matchBrand(name: string, categoryColor?: string): SubscriptionBrandMatch {
  ...
  return {
    ...
    bgColor: categoryColor
      ? categoryColor.replace(')', ',0.08)').replace('rgb', 'rgba').replace(/rgba\(([^,]+,[^,]+,[^,]+),/, 'rgba($1,')
      : FALLBACK.bgColor,
  }
}
