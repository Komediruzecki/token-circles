...
- Name: accounts-crud.spec.ts >> Accounts CRUD Operations >> should display activity list
- Location: tests/accounts-crud.spec.ts:162:3
...
Locator: locator('.activity-list')
Expected: visible
Error: strict mode violation: locator('.activity-list') resolved to 2 elements:
    1) <div class="activity-list"></div> aka locator('.activity-list').first()
    2) <div class="activity-list"></div> aka locator('div:nth-child(2) > .account-activity > .activity-list')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('.activity-list')
