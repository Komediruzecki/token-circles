...
- Name: accounts-crud.spec.ts >> Accounts CRUD Operations >> should have account type options
- Location: tests/accounts-crud.spec.ts:296:3

# Error details

```
Error: locator.selectOption: Error: strict mode violation: locator('.modal-overlay').locator('select') resolved to 2 elements:
